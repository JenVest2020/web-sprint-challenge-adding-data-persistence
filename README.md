...
Relational Databases are the actual databases themselves,
SQL is a management system that manipulates the data with Structured Query Language.

2. Why do tables need a `primary key`?

A primary key ensures row-level accessibility and uniqueness of the table.
...
Foreign keys and a 'bridge' table.
